    ...
    return (
        <>
            ...
            <form className="container shadow d-flex justify-content-center flex-column align-items-center form  ">
                <div class="row d-flex justify-content-center align-items-center flex-column  mb-3">
                    <div className="col-12">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Name</label>
                        <div class="col ">
                            <input type="text" class="form-control email" id="inputEmail3" autoComplete="off"  />
                        </div>
                    </div>
                    <div className="col-12">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Email</label>
                        <div class="col ">
                            <input type="email" class="form-control email" id="inputEmail3" autoComplete="off" />
                        </div>
                    </div>
                    <div className="col-12">
                ...
                <button type="submit" class="btn btn-primary submit mb-3">SUBMIT</button>
            </form>
        </>
    )
}
