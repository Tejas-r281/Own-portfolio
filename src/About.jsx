...
function About() {
    return (
        <>
            <h1 className="heading mb-5"><span className="rounded shadow p-3">About me</span></h1>
            <div className="container-fluid   about">
                <div className="container me ">
                    <div className="row ">
                        <div className="col-lg-6 d-flex justify-content-center  flex-column align-items-center order-lg-1  mt-4   order-2">
                            <div className="upper  ">
                                <h2>
                        ...
                        <div className="col-lg-6 d-flex justify-content-center align-items-center   order-lg-2 mt-4 order-1">
                            <div className="content d-flex justify-content-center align-items-center flex-column  ">
                                ...
                                <div className="mt-5 mb-lg-5 bottom d-flex justify-content-center align-items-center flex-column">
